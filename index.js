...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.3br3aua.mongodb.net/?retryWrites=true&w=majority`;
...
async function run() {
    try {
        ...
        // user post to get products by ids
